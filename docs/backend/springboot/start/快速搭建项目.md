...
我在B站录制了一个详细的视频教程，想看视频教程的可以跳转-[使用IDEA快速搭建SpringBoot项目](https://www.bilibili.com/video/BV1Qt4y1y7Ra)
...
启动 `HelloSpringBootApplication` 的 `main()` 方法，浏览器访问 [http://localhost:8080](http://localhost:8080/) 可以看到：
